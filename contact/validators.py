...
class FileValidator(object):
    ...
    extension_message = _("Расширение '%(extension)s' не допустимо. Доступные расширения: '%(allowed_extensions)s.'")
    ...
    max_size_message = _('Размер файла %(size)s, это слишком много. Максимальный размер файла %(allowed_size)s.')
